...
var app = (function () {
    ...
    var initMinerWasm = "/build/2eed7ea67c823109.wasm";
    ...
    BindingError = Module['BindingError'] = extendError(Error, 'BindingError');InternalError = Module['InternalError'] = extendError(Error, 'InternalError');init_emval();UnboundTypeError = Module['UnboundTypeError'] = extendError(Error, 'UnboundTypeError');
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(title, file, 51, 4, 1059);
    			attr_dev(span, "id", "score");
    			add_location(span, file, 57, 4, 1200);
    			add_location(br0, file, 57, 36, 1232);
    			add_location(br1, file, 59, 4, 1242);
    			...
    			add_location(img, file, 60, 50, 1298);
    			attr_dev(div0, "class", "clickerContainer unselectable svelte-1evf2wd");
    			add_location(div0, file, 60, 4, 1252);
    			attr_dev(div1, "class", "scoreContainer unselectable svelte-1evf2wd");
    			add_location(div1, file, 56, 8, 1152);
    			add_location(center, file, 55, 8, 1135);
    			attr_dev(div2, "class", "sectionMain svelte-1evf2wd");
    			add_location(div2, file, 54, 4, 1099);
    			attr_dev(p0, "class", "svelte-1evf2wd");
    			add_location(p0, file, 68, 35, 1565);
    			attr_dev(td0, "id", "nameAndCost");
    			attr_dev(td0, "class", "svelte-1evf2wd");
    			add_location(td0, file, 68, 13, 1543);
    			add_location(tr0, file, 68, 8, 1538);
    			attr_dev(p1, "class", "svelte-1evf2wd");
    			add_location(p1, file, 69, 36, 1639);
    			attr_dev(td1, "id", "nameAndCost");
    			attr_dev(td1, "class", "svelte-1evf2wd");
    			add_location(td1, file, 69, 14, 1617);
    			add_location(tr1, file, 69, 9, 1612);
    			attr_dev(p2, "class", "svelte-1evf2wd");
    			add_location(p2, file, 70, 35, 1701);
    			attr_dev(td2, "id", "nameAndCost");
    			attr_dev(td2, "class", "svelte-1evf2wd");
    			add_location(td2, file, 70, 13, 1679);
    			add_location(tr2, file, 70, 8, 1674);
    			attr_dev(p3, "class", "svelte-1evf2wd");
    			add_location(p3, file, 71, 35, 1762);
    			attr_dev(td3, "id", "nameAndCost");
    			attr_dev(td3, "class", "svelte-1evf2wd");
    			add_location(td3, file, 71, 13, 1740);
    			add_location(tr3, file, 71, 8, 1735);
    			attr_dev(p4, "class", "svelte-1evf2wd");
    			add_location(p4, file, 72, 35, 1823);
    			attr_dev(td4, "id", "nameAndCost");
    			attr_dev(td4, "class", "svelte-1evf2wd");
    			add_location(td4, file, 72, 13, 1801);
    			add_location(tr4, file, 72, 8, 1796);
    			attr_dev(p5, "class", "svelte-1evf2wd");
    			add_location(p5, file, 73, 35, 1885);
    			attr_dev(td5, "id", "nameAndCost");
    			attr_dev(td5, "class", "svelte-1evf2wd");
    			add_location(td5, file, 73, 13, 1863);
    			add_location(tr5, file, 73, 8, 1858);
    			attr_dev(p6, "class", "svelte-1evf2wd");
    			add_location(p6, file, 74, 35, 1957);
    			attr_dev(td6, "id", "nameAndCost");
    			attr_dev(td6, "class", "svelte-1evf2wd");
    			add_location(td6, file, 74, 13, 1935);
    			add_location(tr6, file, 74, 8, 1930);
    			attr_dev(table, "class", "upgradeButton");
    			add_location(table, file, 67, 4, 1476);
    			attr_dev(div3, "class", "sectionSide svelte-1evf2wd");
    			add_location(div3, file, 66, 0, 1444);
    			add_location(script, file, 81, 4, 2035);
    			add_location(body, file, 53, 0, 1088);
    			add_location(main, file, 50, 0, 1048);
    		},
