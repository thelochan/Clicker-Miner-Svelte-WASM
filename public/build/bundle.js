    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br, file, 56, 8, 1305);
    			attr_dev(div0, "class", "scoreContainer unselectable svelte-15t1zkd");
    			add_location(div0, file, 52, 12, 1207);
    			add_location(center, file, 51, 12, 1186);
    			attr_dev(div1, "class", "sectionMain svelte-15t1zkd");
    			add_location(div1, file, 50, 8, 1146);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div1, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*mine*/ 128) clicker_changes.mine = /*mine*/ ctx[7];
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(title, file, 45, 4, 1070);
    			add_location(body, file, 47, 0, 1108);
    			add_location(main, file, 44, 0, 1059);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, mine, source, $score*/ 387) {
