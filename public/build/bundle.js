...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 6, 0, 49);
    			add_location(br, file$1, 6, 38, 87);
    		},
    ...
    class Score extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { score: 0 });
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Miner> was created with unknown prop '${key}'`);
    	});
    ...
    class Miner extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { _mine: 1 });
    ...
    function create_default_slot(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[3](/*mine*/ ctx[8], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			div0 = element("div");
    			img = element("img");
    			add_location(br, file, 55, 8, 1252);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(title, file, 44, 4, 1027);
    			add_location(body, file, 46, 0, 1056);
    			add_location(main, file, 43, 0, 1016);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, source, $score*/ 515) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = (mine, amount) => mine(source, "21e8");
    	...
    	return [source, $score, $rotations, click_handler];
    }
